...
//extern unsigned char WriteBuffer[1024]; //储存 ADC接受数据
extern  uint8_t Rx_set[2];
extern  uint8_t Rx_real[2];
...
void CAN_RX_IRQHandler(void)
{
	...
	if(RxMessage.StdId==0x0100)  // 1314--100  EXT--STD ysm
	{
		Rx_set[0] =  RxMessage.Data[0];
		Rx_set[1] =  RxMessage.Data[1];
		
		Rx_real[0] = RxMessage.Data[2];
		Rx_real[1] = RxMessage.Data[3];
	}
